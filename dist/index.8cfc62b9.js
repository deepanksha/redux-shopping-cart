...
var _productsList = require("./store/productsList");
...
console.log(store);
store.dispatch((0, _cartReducer.addCartItem)(1, 1));
store.dispatch((0, _cartReducer.addCartItem)(2, 12));
store.dispatch((0, _cartReducer.addCartItem)(5, 13));
store.dispatch((0, _cartReducer.addCartItem)(12, 30));
store.dispatch((0, _cartReducer.addCartItem)(3, 1));
store.dispatch((0, _cartReducer.removeCartItem)(2));
store.dispatch((0, _cartReducer.incrementCartItemQuantity)(5));
store.dispatch((0, _cartReducer.decreaseCartItemQuantity)(12));
store.dispatch((0, _cartReducer.decreaseCartItemQuantity)(1));
// const a = decreaseCartItemQuantity(70);
// console.log(a, "from line 138");
store.dispatch((0, _wishListReducer.wishListAddItem)(1));
store.dispatch((0, _wishListReducer.wishListAddItem)(13));
store.dispatch((0, _wishListReducer.wishListAddItem)(24));
store.dispatch((0, _wishListReducer.wishListRemoveItem)(1));
console.log(store.getState());

},{"redux":"anWnS","./wishListReducer":"eKMDw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./store/cartReducer":"kNTZ9","./store/productsList":"lBc2M","./store/productsReducer":"4j4f8"}],"anWnS":[function(require,module,exports) {
...
},{}],"eKMDw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "incrementCartItemQuantity", ()=>incrementCartItemQuantity);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lBc2M":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4j4f8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>productsReducer);
var _productsList = require("./productsList");
function productsReducer(state = (0, _productsList.productList)) {
    return state;
}

},{"./productsList":"lBc2M","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequire94c2")
